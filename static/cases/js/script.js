...
function pageLoaded() {
    ...
    var img = document.querySelector("#caseImage");
    ...
    populateValues(id_web_url, questions, title, desc, img, questionTitle, item, caseStudy)
